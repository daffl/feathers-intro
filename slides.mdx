...
- __Transport agnostic:__ Services can be used by any client like a GUI (Electron), REST or Socket.io API wrapper or GraphQL resolver
...
- Easy database integrations (Feathers supports 15+ databases and ORMs)
